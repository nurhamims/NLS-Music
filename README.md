<div align="center">
  <img src="assets/Echo-new.png" alt="NLS music Logo" width="140"/>
  ...
  <a href="https://NLS music.fun/download">
    <img src="assets/download.png" alt="Download" width="180"/>
  </a>
  &nbsp;
  <a href="https://NLS music.fun/obtainium">
...
NLS music delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
4. **Build the Application**
   NLS music has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
If NLS music has been useful to you, consider supporting its development.
...
NLS music stands on the shoulders of several excellent open-source projects. Sincere thanks to:
